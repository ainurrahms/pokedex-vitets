const Card = () => {
  return (
    <div className="font-sans mt-12 bg-gray-700 max-w-[300px] rounded-xl hover:bg-gray-900 hover:scale-110 duration-700 p-5">
      ...
      <h4 className="py-2 font-bold text-white">Name of Pokemon</h4>
      <p className="space-y-4 text-sm leading-7 text-slate-300">Description of pokemon</p>
      <div className="flex justify-center pt-5 pb-2">
        <button className="h-10 font-semibold duration-500 bg-indigo-100 rounded-md w-28 hover:scale-90">
          Read More
        </button>
      </div>
    </div>
